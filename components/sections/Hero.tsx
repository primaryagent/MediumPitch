    ...
    <section id="hero" className="min-h-screen flex items-center justify-center border-b border-white/5">
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        ...
        <p className="text-xl md:text-2xl leading-relaxed max-w-3xl">
          ...
          Platform operational. Legal opinion to proceed November 2025. Custody integration complete December 2025. Live launch April 27, 2026. First securitized Bitcoin installment credit product paying institutional investors fixed interest while giving consumers leverage without margin calls. 10-year terms at 15% effective APR. No forced liquidations, ever.
        </p>
      </div>
    </section>
  );
